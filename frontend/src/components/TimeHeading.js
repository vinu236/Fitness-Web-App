...
const TimeHeading=()=>{
    ...
    return(
        <div className="flex flex-wrap p-5 mt-10     ml-6 mr-7 rounded-tl-[200px] rounded-br-[200px] rounded-3xl justify-center gap-[12px] items-center  bg-neutral-800 opacity-90 shadow-2xl">
           <div>
           <BsClock className="text-custom-head text-7xl animate-spin " />
            </div> 
